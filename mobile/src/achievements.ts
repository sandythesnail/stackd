...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'crisis_averted', tier: 'silver', label: 'Crisis Averted', desc: 'Beat a Credit boss battle.', char: '⚡', available: true },
  { id: 'fraud_fighter', tier: 'silver', label: 'Fraud Fighter', desc: 'Beat a Scams boss battle.', char: '🔒', available: true },
  { id: 'no_hints', tier: 'silver', label: 'No Hints Needed', desc: 'Finish the first credit quest with zero hints.', char: '🧭', available: true },
  { id: 'word_nerd', tier: 'silver', label: 'Word Nerd', desc: 'Learn 15+ vocab terms across your quests.', char: '📖', available: true },
