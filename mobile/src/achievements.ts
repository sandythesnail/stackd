...
export const ACHIEVEMENTS: Achievement[] = [
  { id: 'first_paycheck', tier: 'bronze', label: 'First Paycheck', desc: 'Ace all 8 lessons in the Earning module.', color: '#3FA65C', available: true,
    icon: '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>' },
  { id: 'budget_boss', tier: 'bronze', label: 'Budget Boss', desc: 'Ace all 8 lessons in the Spending module.', color: '#E08A2E', available: true,
  ...
  { id: 'safety_net', tier: 'bronze', label: 'Safety Net', desc: 'Ace all 8 lessons in the Saving module.', color: '#1C9C93', available: true,
  ...
  { id: 'investor', tier: 'bronze', label: 'Future Millionaire', desc: 'Ace all 8 lessons in the Investing module.', color: '#3B7FC4', available: true,
    icon: '<polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/>' },
  { id: 'credit_champ', tier: 'bronze', label: 'Credit Champ', desc: 'Ace all 8 lessons in the Managing Credit module.', color: '#2E9BD6', available: true,
    icon: '<rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/>' },
  { id: 'risk_ready', tier: 'bronze', label: 'Risk Ready', desc: 'Ace all 8 lessons in the Managing Risk module.', color: '#5B6B8C', available: true,
    icon: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>' },
  { id: 'loan_smart', tier: 'bronze', label: 'Loan Smart', desc: 'Ace all 8 lessons in the Loans module.', color: '#A9713C', available: true,
    icon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>' },
  { id: 'tax_ready', tier: 'bronze', label: 'Tax Ready', desc: 'Ace all 8 lessons in the Taxes module.', color: '#8B5FBF', available: true,
    icon: '<line x1="19" y1="5" x2="5" y2="19"/><circle cx="6.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/>' },
  { id: 'mindful_money', tier: 'bronze', label: 'Mindful Spender', desc: 'Ace all 8 lessons in the Consumer Psychology module.', color: '#D6538A', available: true,
    icon: '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>' },
  { id: 'offer_ready', tier: 'bronze', label: 'Offer Ready', desc: 'Ace all 8 lessons in the Career & Salary module.', color: '#5C6BC0', available: true,
    icon: '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>' },
  { id: 'scam_spotter', tier: 'bronze', label: 'Scam Spotter', desc: 'Ace all 8 lessons in the Scams & Fraud Prevention module.', color: '#C0453A', available: true,
